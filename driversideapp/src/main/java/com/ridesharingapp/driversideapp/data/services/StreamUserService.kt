...
import com.ridesharingapp.driversideapp.data.keys.KEY_IMAGE

import com.ridesharingapp.driversideapp.data.keys.KEY_ROLE
import com.ridesharingapp.driversideapp.data.keys.KEY_STATUS
import com.ridesharingapp.driversideapp.data.keys.KEY_TYPE
...
class StreamUserService(
    ...
    override suspend fun logOutUser(user: GrabLamUser) =
        withContext(Dispatchers.IO) {
